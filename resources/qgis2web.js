...
map.getView().fit([8468822.919085, 1310317.542655, 8486559.654320, 1320130.528145], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">poothadiwebgis</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (112 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Poothadi is a village in Wayanad district, Kerala, India,[1] with its present headquarters located at Kenichira.';
            }
